...
<TABLE class='table table-striped'>
  ...
  <c:forEach var="usercateVO" items = "${list }">
    ...
    <TR>
      <TD style='text-align: center;'>${usercateVO.seqno }</TD>
      <TD><a href="../subcategrp/list.do?usercateno=${usercateno }"> ${usercateVO.name }</a> </TD>
      <TD style='text-align: center;'>${usercateVO.rdate.substring(0, 10) }</TD>
      <TD style='text-align: center;'>${usercateVO.visible }</TD>
      <TD style='text-align: center;'>
        <A href="./update_seqno_up.do?usercateno=${usercateno }"><IMG src='../images/up.png' title='우선순위 높임' style='width: 16px;'></A>
        <A href="./update_seqno_down.do?usercateno=${usercateno }"><IMG src='../images/down.png' title='우선순위 낮춤' style='width: 16px;'></A>
